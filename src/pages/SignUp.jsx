...
const SignUp = () => {
    return (
        <main className="container mx-auto px-3 ptop">
            ...
            <h2 className="text-xl text-center mb-5 text-secondary md:text-orange">Sign Up today</h2>
            ...
            <section className="flex flex-col justify-center items-center md:flex-row-reverse  gap-10">
                <div className="w-full absolute top--1 z--10 showcaseimg hidden md:block">
                    <img src={signUP} alt="Login in to continue" className='w-full rounded-md opacity-90' />
                </div>

                <form className="w-full bg-gray-100 rounded-sm py-4 px-2 drop-shadow-md md:w-[30rem]">
                    <div className='flex flex-col justify-start items-start mb-5'>
                        <label htmlFor="name" className='text-xl mb-2 text-orange inline-block'>Username</label>
                    ...
                    <div className='flex flex-col justify-start items-start'>
                        <label htmlFor="email" className='text-xl mb-2 text-orange inline-block'>Confirm Password</label>
                        <input type="password" className="drop-shadow-lg px-2 py-3 w-full rounded-md outline-0 text-md" />
                    </div>
